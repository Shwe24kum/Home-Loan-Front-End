    ...
    <div>
       ...
       <div className="col-md-4 col-sm-4 col-xs-12"> </div>
         <div className="col=md-4 col-sm-5 col-xs-12">
          <form>
             <h1 className="bg-dark text-light p-3">Finance Officer Registration  </h1>
             ...
             <div className="form-group">
              ...
              <input type="finofficername" className="form-control" placeholder="Enter FinOfficerName" />
              </div>
              <div className="form-group">
              <label>FinOfficerContact</label>
              <input type="finofficercontact" className="form-control" placeholder="Enter FinOfficerContact" />
              </div>
